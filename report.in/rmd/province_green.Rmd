...
report$plot$province.county.index.radar$data$keep <- list(list(var = "x", value=c("本市")))
fig_file  <- plot.figure( report = report, plot.in = report$plot[[plot.entry]] ,fig_name = fig_name)
```
\begin{figure}[H]
\includegraphics[width=\textwidth]{`r fig_file`}
...
plot.entry <- "province.county.index.radar"
report$plot$province.county.index.radar$data$keep <- list(list(var = "x", value=c("本市","72区")))
fig_file  <- plot.figure( report = report, plot.in = report$plot[[plot.entry]] ,fig_name = fig_name)
```
\begin{figure}[H]
\includegraphics[width=\textwidth]{`r fig_file`}
...
plot.entry <- "province.county.index.radar"
report$plot$province.county.index.radar$data$keep <- list(list(var = "x", value=c("本市","73区")))
fig_file  <- plot.figure( report = report, plot.in = report$plot[[plot.entry]] ,fig_name = fig_name)
```
\begin{figure}[H]
\includegraphics[width=\textwidth]{`r fig_file`}
...
plot.entry <- "province.county.index.radar"
report$plot$province.county.index.radar$data$keep <- list(list(var = "x", value=c("本市","75区")))
fig_file  <- plot.figure( report = report, plot.in = report$plot[[plot.entry]] ,fig_name = fig_name)
```
\begin{figure}[H]
\includegraphics[width=\textwidth]{`r fig_file`}
...
plot.entry <- "province.county.index.radar"
report$plot$province.county.index.radar$data$keep <- list(list(var = "x", value=c("本市","76区")))
fig_file  <- plot.figure( report = report, plot.in = report$plot[[plot.entry]] ,fig_name = fig_name)
```
\begin{figure}[H]
\includegraphics[width=\textwidth]{`r fig_file`}
...
plot.entry <- "province.county.index.radar"
report$plot$province.county.index.radar$data$keep <- list(list(var = "x", value=c("本市","77区")))
fig_file  <- plot.figure( report = report, plot.in = report$plot[[plot.entry]] ,fig_name = fig_name)
```
\begin{figure}[H]
\includegraphics[width=\textwidth]{`r fig_file`}
...
plot.entry <- "province.county.index.radar"
report$plot$province.county.index.radar$data$keep <- list(list(var = "x", value=c("本市","78区")))
fig_file  <- plot.figure( report = report, plot.in = report$plot[[plot.entry]] ,fig_name = fig_name)
```
\begin{figure}[H]
\includegraphics[width=\textwidth]{`r fig_file`}
...
plot.entry <- "province.county.index.radar"
report$plot$province.county.index.radar$data$keep <- list(list(var = "x", value=c("本市","79区")))
fig_file  <- plot.figure( report = report, plot.in = report$plot[[plot.entry]] ,fig_name = fig_name)
```
\begin{figure}[H]
\includegraphics[width=\textwidth]{`r fig_file`}
...
plot.entry <- "province.county.index.radar"
report$plot$province.county.index.radar$data$keep <- list(list(var = "x", value=c("本市","80区")))
fig_file  <- plot.figure( report = report, plot.in = report$plot[[plot.entry]] ,fig_name = fig_name)
```
\begin{figure}[H]
\includegraphics[width=\textwidth]{`r fig_file`}
...
plot.entry <- "province.county.index.radar"
report$plot$province.county.index.radar$data$keep <- list(list(var = "x", value=c("本市","81区")))
fig_file  <- plot.figure( report = report, plot.in = report$plot[[plot.entry]] ,fig_name = fig_name)
```
\begin{figure}[H]
\includegraphics[width=\textwidth]{`r fig_file`}
...
plot.entry <- "province.county.index.radar"
report$plot$province.county.index.radar$data$keep <- list(list(var = "x", value=c("本市","82区")))
fig_file  <- plot.figure( report = report, plot.in = report$plot[[plot.entry]] ,fig_name = fig_name)
```
\begin{figure}[H]
\includegraphics[width=\textwidth]{`r fig_file`}
...
plot.entry <- "province.county.index.radar"
report$plot$province.county.index.radar$data$keep <- list(list(var = "x", value=c("本市","83区")))
fig_file  <- plot.figure( report = report, plot.in = report$plot[[plot.entry]] ,fig_name = fig_name)
```
\begin{figure}[H]
\includegraphics[width=\textwidth]{`r fig_file`}
...
plot.entry <- "province.county.index.radar"
report$plot$province.county.index.radar$data$keep <- list(list(var = "x", value=c("本市","84区")))
fig_file  <- plot.figure( report = report, plot.in = report$plot[[plot.entry]] ,fig_name = fig_name)
```
\begin{figure}[H]
\includegraphics[width=\textwidth]{`r fig_file`}
...
图\ref{fig:`r fig_name`}给出了区86四年级的各指标雷达分析图。`r fig_name <- "四年级各指标雷达分析图—区86" `
```{r province.county86.index.radar, echo=FALSE, message=FALSE, include = FALSE, result="hide"}
plot.entry <- "province.county.index.radar"
report$plot$province.county.index.radar$data$keep <- list(list(var = "x", value=c("本市","86区")))
fig_file  <- plot.figure( report = report, plot.in = report$plot[[plot.entry]] ,fig_name = fig_name)
```
\begin{figure}[H]
\includegraphics[width=\textwidth]{`r fig_file`}
...
plot.entry <- "province.county.index.radar"
report$plot$province.county.index.radar$data$keep <- list(list(var = "x", value=c("本市","87区")))
fig_file  <- plot.figure( report = report, plot.in = report$plot[[plot.entry]] ,fig_name = fig_name)
```
\begin{figure}[H]
\includegraphics[width=\textwidth]{`r fig_file`}
...
plot.entry <- "province.county.index.radar"
report$plot$province.county.index.radar$data$keep <- list(list(var = "x", value=c("本市","88区")))
fig_file  <- plot.figure( report = report, plot.in = report$plot[[plot.entry]] ,fig_name = fig_name)
```
\begin{figure}[H]
\includegraphics[width=\textwidth]{`r fig_file`}
...
plot.entry <- "province.county.index.radar"
report$plot$province.county.index.radar$data$keep <- list(list(var = "x", value=c("本市","89区")))
fig_file  <- plot.figure( report = report, plot.in = report$plot[[plot.entry]] ,fig_name = fig_name)
```
\begin{figure}[H]
\includegraphics[width=\textwidth]{`r fig_file`}
