...
\setCJKmainfont[BoldFont={PingFang SC},ItalicFont={Kai},BoldItalicFont={PingFang SC}]{STFangsong}
...
\newcommand{\mytitle}[1]{
    \begin{center}\fontsize{27.5pt}{30pt}\selectfont#1\end{center}
}

\newcommand{\mysubtitle}[1]{
    \begin{center}\fontsize{24pt}{32pt}\selectfont\textbf{\textit{#1}}\end{center}
}
...
\newcommand{\questiontitle}[1]{
    \begin{bf}\raggedright\fontsize{16pt}{24pt}\selectfont#1\end{bf}
}
